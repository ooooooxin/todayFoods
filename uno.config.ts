...
export default defineConfig({
  ...
  rules: [
    ...
    ['scale-81', { transform: 'scale(0.81)' }],
  ],
  theme: {
    colors: {
      /** 主题色，用法如: text-primary bg-primary */
      primary: 'var(--wot-color-theme,#333)',
      /** 成功色，用法如: text-success */
      success: 'var(--wot-color-success,#07C160)',
      /** 错误色，用法如: text-error */
      error: 'var(--wot-color-error,#fa5151)',
      /** 提示色，用法如: text-tip */
      tip: 'var(--wot-color-tip,#477fff)',
      /** 屏蔽色，用法如: text-block */
      block: 'var(--wot-color-block,#eabd19)',
      /** 主要文本色，用法如: text-main */
      main: 'var(--wot-color-main,#181818)',
      /** 禁用文本色，用法如: text-disabled */
      disabled: 'var(--wot-color-disabled,#F5F5F5)',
    },
    fontSize: {
