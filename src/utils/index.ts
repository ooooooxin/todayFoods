 ...
 * 用于拼接图片路径
 * @example
 * const imgUrl = IMG_BASE_URL + '/assets/mp/shzx.png'
 */
export const IMG_BASE_URL = 'https://genesis-yq-prod.oss-cn-shenzhen.aliyuncs.com'
 ...
 * @returns 完整的图片 URL
 * @example
 * getImgUrl('/assets/mp/shzx.png') // 'https://genesis-yq-prod.oss-cn-shenzhen.aliyuncs.com/assets/mp/shzx.png'
 */
export function getImgUrl(path: string): string {
  return `${IMG_BASE_URL}${path}`
}

export { getSearchKeywordParam, normalizeSearchKeywordForRequest } from './searchKeyword'
